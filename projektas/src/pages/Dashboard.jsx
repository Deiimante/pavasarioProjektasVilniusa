        ...
        <div className="col p-4 bg-light">
          ...
          <div className="d-flex justify-content-between align-items-center mb-4">
            ...
            <div className="d-flex gap-2">
              <div>
                <input type="text" className="form-control" placeholder="Search transactions..."></input>
              </div>
              <button className="btn btn-primary" onClick={handleNew} > {/*onClick={handleNew}*/}
                + New Transaction
              </button>
            </div>
          </div>
              ...
              <div className="card shadow-sm border-0 p-4 bg-primary text-white ">
                  ...
                  <div className="d-flex justify-content-between">
                    ...
                    <svg id="Finance--Streamline-Carbon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" height="16" width="16">
                        ...
                        <defs></defs>
                        <title>finance</title>
                        <path d="M1 14h14v1H1Z" fill="#ffffff" strokeWidth="0.5"></path>
                        <path d="M13.5 5.5a0.5 0.5 0 0 0 0.5 -0.5V3.5a0.5 0.5 0 0 0 -0.33 -0.47l-5.5 -2a0.5 0.5 0 0 0 -0.34 0l-5.5 2A0.5 0.5 0 0 0 2 3.5v1.5a0.5 0.5 0 0 0 0.5 0.5h0.5v6.5H2v1h12v-1h-1V5.5ZM3 3.85l5 -1.82L13 3.85V4.5H3ZM9 12h-2V5.5h2ZM4 5.5h2v6.5H4Zm8 6.5h-2V5.5h2Z" fill="#ffffff" strokeWidth="0.5"></path>
              ...
              <div className="card shadow-sm border-0 p-4">
                ...
                <div className="d-flex justify-content-between">
                  ...
                  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" id="Arrow-Down--Streamline-Solar-Ar" height="24" width="24">
                    ...
                    <path d="m12 4 0 16m0 0 6 -6m-6 6 -6 -6" stroke="#198754" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"></path>
                  </svg>
                </div>
