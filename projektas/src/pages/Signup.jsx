...
const Signup_page = () => { //{ setCurrentUser }
        ...
        <div className="container-fluid p-0">
            <div className="row g-0 vh-100">
                ...
                <div className="col-lg-6 bg-white d-flex flex-column">
                    ...
                    <header className="p-4 d-flex justify-content-strt">
                    ...
                    <div className="flex-grow-1 d-flex align-items-center justify-content-center">
                        <div className="w-100" style={{ maxWidth: '420px', padding: '40px 20px' }}>
                            <div className="mb-5 text-center">
                                <h2 className="fw-bold display-6">Join WealthWise</h2>
                                <p className="text-muted">Start your journey to better budget management today.</p>
                            </div>
                            ...
                            <div className="d-flex align-items-center my-4">
                                ...
                                <span className="mx-3 text-muted small fw-bold">OR SIGNUP WITH EMAIL</span>
                                <hr className="flex-grow-1 text-muted opacity-25" />
                            </div>

                            <form>
                                <div className="mb-3">
                                    <label className="form-label d-flex justify-content-start small fw-bold text-uppercase text-muted">Full Name</label>
                                    <input type="email" className="form-control form-control-lg bg-light border-0 fs-6" placeholder="Enter your full name" required value={name} onChange={(e) => setName(e.target.value)} />
                                </div>
                                ...
                                <div className="mb-3">
                                    ...
                                    <input type="password" className="form-control form-control-lg bg-light border-0 fs-6" placeholder="Create a strong password" required value={password} onChange={(e) => setPassword(e.target.value)} />
                                ...
                                <div className="d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label small text-muted" htmlFor="rememberMe">I agree to the <a href="">Terms of Service</a> and <a href="">Privacy Policy</a>.</label>
                                    </div>
                                </div>
                                ...
                                <p className="text-center text-muted fs-6">
                                    Already have an account? <a href="#" className="text-decoration-none fw-bold">Log In</a>
                                </p>
                            </form>
                        </div>
                    </div>
